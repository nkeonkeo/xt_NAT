...
#define NAT_TIMEOUT_TCP_EST	(600 * HZ)
#define NAT_TIMEOUT_UDP_EST	(60 * HZ)
#define NAT_TIMEOUT_SHORT	(10 * HZ)
#define NAT_TIMEOUT_CLOSE	(5 * HZ)

#define PORT_BITMAP_BITS	65536
#define PORT_BITMAP_PROTOS	3   /* TCP=0, UDP=1, ICMP=2 */

#define NAT6_CREATE_LOCK_BITS	16
